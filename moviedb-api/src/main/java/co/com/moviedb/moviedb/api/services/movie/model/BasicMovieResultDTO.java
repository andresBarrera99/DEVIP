...
public class BasicMovieResultDTO {
	...
	public String toString() {
		return "BasicMovieResultDTO [adult=" + adult + ", backdropPath=" + backdropPath + ", genreIDs=" + genreIDs
				+ ", id=" + id + ", originalLanguage=" + originalLanguage + ", originalTitle=" + originalTitle
				+ ", overview=" + overview + ", popularity=" + popularity + ", posterPath=" + posterPath
				+ ", releaseDate=" + releaseDate + ", title=" + title + ", video=" + video + ", voteAverage="
