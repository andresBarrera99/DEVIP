...
public class MovieService extends BaseService<MovieRepository> {
	...
	public BasicResponseDTO<BasicMovieResultDTO> getTopRatedMovies(String page) throws IOException, InformationException {
		...
		return getRepository().getTopRatedMovies(address);
	}
	...
	public BasicResponseDTO<BasicMovieResultDTO> searchMovie(Map<String,String> request) throws IOException, InformationException {
		...
		return getRepository().searchMovie(address);
	}
	
	public MovieDetailResponseDTO getMovieDetail(String movieID) throws IOException, InformationException {
		String address = apiEndPoint+ movieDetailAddress.replace("{movie_id}", movieID);
		System.out.println("url: "+ address);
		return getRepository().getMovieDetail(address);
	}
	...
	@Value("${moviedb.api.movie.detail}")
